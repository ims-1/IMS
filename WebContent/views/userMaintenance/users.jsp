...
<body>
	<div id="mainContents">
		...
		<div id="usersMainTable" align=center>
			<table id="usersMainBodyList"
				class="table table-striped table-bordered">
				<thead>
					<tr>
						<th colspan="2"><input id="txtSearch" type="text"
							placeholder="Enter keyword to search.." class="form-control"
							onkeyup="filterUserRecords()" /></th>
						<th></th>
						<th></th>
						<th></th>
						<th><button class="btn btn-info btn-lg" onclick="addUser()">
...
<script
	src="${pageContext.request.contextPath}/js/userMaintenance/users.js"></script>
